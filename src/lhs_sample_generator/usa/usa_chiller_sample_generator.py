...
params_WE_Chiller_base = [
    ...
    0.70,      # 15 Pump_e_CW
    4.0,       # 16 AT_CT
    0.30,      # 17 Chiller_load
    5.0,       # 18 delta_T_CT
    200000,    # 19 Pump_Pressure_CT
    0.70,      # 20 Pump_e_CT
    0.001,     # 21 Windage_p
    6.0,       # 22 CC
    300,       # 23 Fan_Pressure_CT
    0.70,      # 24 Fan_e_CT
    1.0,       # 25 LGRatio
    29,        # 26 T_up
    16,        # 27 T_lw
...
print("Generated samples:", all_samples.shape)
print(all_samples[:3])
...
output_path = BASE_DIR / "data" / "lhs_samples" / "usa" / "usa_chiller_samples.csv"
