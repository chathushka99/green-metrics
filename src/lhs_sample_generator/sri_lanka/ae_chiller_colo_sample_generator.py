...
param_ranges = [
    ...
    (8.0, 12.0),  # 6 delta_T_air
    (300, 1200),  # 7 Fan_Pressure_CRAC
    (0.60, 0.80),  # 8 Fan_e_CRAC
    (6000, 7000),  # 9 Pump_Pressure_HD
    ...
    (200, 400),  # 17 Pump_Pressure_CT
    (0.78, 0.88),  # 18 Pump_e_CT
    (0.000005, 0.003),  # 19 Windage_p
    (3.0, 7.0),  # 20 CC
    (200, 400),  # 21 Fan_Pressure_CT
    (0.78, 0.88),  # 22 Fan_e_CT
    (0.90, 1.00),  # 23 SHR
...
# ------------------------------------------------------
# 4) Latin Hypercube Sampling (unit space)
# ------------------------------------------------------
unit_samples = np.array(lhsmdu.sample(n_vars, n_samples)).T

# ------------------------------------------------------
# 5) Scale to real parameter ranges
# ------------------------------------------------------
