...
# ------------------------------------------------------
# 1) Base parameter vector (aligned with function w[i])
# ------------------------------------------------------
params_WE_Chiller_base = [
    None, None, None,   # 0–2 (T_oa, RH_oa, P_oa handled externally)
...
# ------------------------------------------------------
# 2) Parameter ranges (STRICTLY MATCHED)
# ------------------------------------------------------
param_ranges = [
    None, None, None,
    ...
    (166900, 250400),    # 22 Pump_Pressure_CT
...
assert len(params_WE_Chiller_base) == len(param_ranges)
...
output_path = BASE_DIR / "data" / "lhs_samples" / "sri_lanka" / "we_chiller_samples.csv"
